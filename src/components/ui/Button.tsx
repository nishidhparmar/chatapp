...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 max-h-11 whitespace-nowrap  px-5 py-3 rounded-md text-sm font-medium transition-all disabled:pointer-events-none  [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive disabled:bg-neutral-disabled disabled:text-neutral-ct-disabled",
  {
    variants: {
      variant: {
        default:
